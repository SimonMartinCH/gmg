...
<qgis version="2.14.3-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="processus">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{df898eb4-53a1-4d68-9269-da6d21a016f3}">
      <rule filter="&quot;FORM&quot; = 'erratic boulder'" key="{3ae09462-302a-4861-a865-1606a81da20e}" symbol="0" label="erratic boulder"/>
      <rule filter="&quot;FORM&quot; = 'waterfall'" key="{1d39d2ee-a9ee-411c-9ff1-ba8f94fea916}" symbol="1" label="waterfall"/>
      <rule filter="ELSE" key="{28a6ecce-ffc2-42a3-b2f5-8be3f45e2040}" symbol="2"/>
      <rule filter="&quot;FORM&quot; = 'fallen block'" key="{5a6feb6d-9688-4ffd-bec2-62dcadc54a11}" symbol="3" label="fallen block"/>
    </rules>
    <symbols>
  ...
  <displayfield>RuleID</displayfield>
  <label>0</label>
  <labelattributes>
